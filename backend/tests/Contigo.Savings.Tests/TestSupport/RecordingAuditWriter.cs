...
/// enough to prove <see cref="Contigo.Savings.Application.SavingsOpportunityService"/> writes the
/// right audit entries without standing up a real Postgres-backed
/// <c>Contigo.Audit.Infrastructure.AuditWriter</c> — mirrors
/// <c>Contigo.Renewals.Tests.TestSupport.RecordingAuditWriter</c> exactly.
/// </summary>
