...
/// conversion lambda. Module-local (not shared with the other modules' own copies) for the same
/// ADR-002 dependency-direction reason as this module's own <c>Domain.TenantScopedEntity</c>.
/// </summary>
