...
/// wired up yet (no endpoint/queue handler exists to attach a tenant claim to). This task wires
/// the ambient tenant claim (<see cref="ITenantContext"/>) and the RLS connection interceptor
