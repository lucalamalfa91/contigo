...
/// <summary>
/// Base type for every entity owned by the Renewals bounded context (task E03/F03/US01/T02,
/// renewal-action — the first task to give <c>Contigo.Renewals</c> a <c>DbContext</c>). ADR-009
...
/// only allows this module to reference <c>Contigo.SharedKernel</c> (plus <c>Contigo.Benchmark</c>),
/// never another domain module's internals, so the base type is duplicated per module rather than
/// shared.
/// </summary>
